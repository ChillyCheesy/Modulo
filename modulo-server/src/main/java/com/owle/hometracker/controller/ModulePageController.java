package com.owle.hometracker.controller;

import com.owle.hometracker.event.DeleteRequestEvent;
import com.owle.hometracker.event.GetRequestEvent;
import com.owle.hometracker.event.PostRequestEvent;
import com.owle.hometracker.event.PutRequestEvent;
import com.owle.hometracker.modules.Module;
import com.owle.hometracker.modules.ModuleManager;
import com.owle.hometracker.services.PagesService;
...
public class ModulePageController {
    ...
    public RedirectView redirectToMainPage(@PathVariable String module) throws HTModuleNotFoundException {
        final Module htModule = moduleManager.getModule(module);
