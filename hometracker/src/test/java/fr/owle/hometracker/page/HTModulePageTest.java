...
public class HTModulePageTest {
    ...
    public final void init() {
        ...
        final List<HTModule> modules = new ArrayList<>(Arrays.asList(module1, module2));
    ...
    public final void defaultModuleManagerAndDefaultPageManagerTest() {
        ...
        assertEquals(HTAPI.getModule().getModuleManager(), htModulePage.getModuleManager());
        assertEquals(HTAPI.getPage().getPageManager(), htModulePage.getPageManager());
    }
