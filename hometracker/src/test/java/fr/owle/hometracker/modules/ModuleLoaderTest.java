...
public class ModuleLoaderTest {
    ...
    public final void startModulesTest() throws NoSuchFieldException {
        final HTModule module1 = mock(HTModule.class, CALLS_REAL_METHODS);
        final HTModule module2 = mock(HTModule.class, CALLS_REAL_METHODS);
        FieldSetter.setField(module1, HTModule.class.getDeclaredField("config"), config1);
        FieldSetter.setField(module2, HTModule.class.getDeclaredField("config"), config2);
    ...
    public final void startModulesButMissingDependencies() {
        ...
        final HTModule module = mock(HTModule.class, CALLS_REAL_METHODS);
    ...
    public final void afterAll(){
        HTAPI.getModule().getModuleManager().removeModule("MockModule1", "MockModule2", "Hello");
    }
