...
public class CommandStatusOperator extends BetweenOperator implements OperatorListener {
    ...
    public CommandFlow onOperate(Module module, CommandFlow left, CommandFlow center, CommandFlow right) throws CommandException {
        ...
        final CommandFlow flux = processor.execute(module, center);
        return CommandFlowBuilder.combine(left.getAliasManager(), left, CommandFlowBuilder.create(left.getAliasManager(), flux.isSuccess() + ""), right);
    }
