...
public class YamlConfigurationStrategyTest {

    private YamlConfigurationStrategy yamlConfigurationStrategy;
    ...
    public void setUp() {
        final InputStream inputStream = MockStream.fromString("""
                ...
                server:
                  name: My Server
                  port: 8080
                  enabled: true # Benoit I love you
                ewoks:
                - name: Wicket
                  age: 10
                - name: Graak
                ...
                price: 10.5
        """);
        yamlConfigurationStrategy = new YamlConfigurationStrategy();
        try { configuration = yamlConfigurationStrategy.loadConfiguration(inputStream); }
    ...
    @Test
    public void testSaveConfigurationToYaml() throws IOException {
        final MockStream.MockOutputStream outputStream = new MockStream.MockOutputStream();
        yamlConfigurationStrategy.saveConfiguration(configuration, outputStream);
